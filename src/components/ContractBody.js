                            ...
                            <table className="w-2/3 m-2">
                                ...
                                <tr>
                                    ...
                                    {watchContractType === "Deliverer" &&
                                        <>
                                            <td><label htmlFor="affiliatedCompany">Entreprise affiliée</label></td>
                                            <td>
                                                <input {...registerContract("affiliatedCompany")} type="text" id="affiliatedCompany" className={`peer ${errorsContract.affiliatedCompany ? "form-auth-input-invalid invalid" : "form-auth-input-valid valid"}`} required/>
                                                <p className="error-form">
                                                    {errorsContract.affiliatedCompany && <span>{errorsContract.affiliatedCompany.message}</span>}
                                                </p>
                                            </td>
                                        </>
                                    }
