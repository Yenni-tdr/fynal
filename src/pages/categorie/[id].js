import { getAllCategoriesID, getCategorieProductsData } from '../../api/categorie';
...
export async function getServerSideProps({ params }) {
    ...
    // console.log(catData.produits[0]);
...
export default function Categorie({ catData }) {
    return (
        <div>
            <h1 className='text-center mt-8 font-semibold text-2xl italic'>{ catData.libelle }</h1>
